# The name of this view in Looker is "Sinistralidade Frequencia Ans"
view: sinistralidade_frequencia_ans {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `apresentacao.sinistralidade_frequencia_ans` ;;
