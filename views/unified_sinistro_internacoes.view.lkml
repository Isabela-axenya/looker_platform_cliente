# The name of this view in Looker is "Unified Sinistro Internacoes"
view: unified_sinistro_internacoes {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `apresentacao.unified_sinistro_internacoes` ;;
  ...
  dimension_group: data_feriado {
    type: time
    timeframes: [raw, date, week, month, quarter, year]
    convert_tz: no
    datatype: date
    sql: ${TABLE}.data_feriado ;;
  }
  ...
  dimension: elegiveis_ca_colon {
    type: string
    sql: ${TABLE}.elegiveis_ca_colon ;;
  }
  ...
  dimension: elevigeis_ca_prostata {
    type: string
    sql: ${TABLE}.elevigeis_ca_prostata ;;
  }
  ...
  dimension: is_consulta_eletiva {
    type: yesno
    sql: ${TABLE}.is_consulta_eletiva ;;
  }
