# The name of this view in Looker is "Beneficios Apolice Hub Table"
view: beneficios_apolice_hub_table {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `apresentacao.beneficios_apolice_hub_table` ;;
